...
Item {
    ...
    readonly property bool streamStatsVisible: Chiaki.settings.streamStatsMode > 0 && !(menuController.open || menuController.closing) && !sessionLoading && !sessionError && !(Chiaki.settings.audioVideoDisabled & 0x02)
